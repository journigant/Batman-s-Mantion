...
public class Game
{
    ...
    private Player P1 = new Player("P1", 50);   
    /**
    ...
    {
        Room study, entranceHall, masterBedroom,masterBathroom, masterCloset, lab,labCloset, batCave, garage, studyCloset;
      
        // create the rooms
        study = new Room("in the study");
        studyCloset = new Room("inside the study room closet");
        entranceHall = new Room("in a Entrance Hall");
        masterBedroom = new Room("in master Bedroom");
    ...
    {
        System.out.println();
         System.out.println("Welcome to the World Gary's Mansion!");    
        System.out.println("The World of Gary's Mansion is a new, incredibly boring adventure game.");
    ...
    private void takeItem(Command command)
    {
        ...
        String item = command.getSecondWord();      
            Item deletedRoomItem = currentRoom.removeItem(item);
            P1.pickUpItem(deletedRoomItem);
        }
    ...
    private void dropItem(Command command)
    {
        ...
        String item = command.getSecondWord();
            Item droppedItem = P1.dropItem(item);
